...
public enum FederationTile implements UpdatePlayer {
  ...
  private static class EnumUtil {
    ...
    private static final UpdatePlayer VP_BONUS = p -> p.updateScore(12, PREFIX);

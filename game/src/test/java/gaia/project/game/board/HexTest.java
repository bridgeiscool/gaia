...
public class HexTest {
  ...
  public void adjacentHex() {
    Hex reference = EmptyHex.normal(new Coords(0, 0), 1, "9.5");
    Hex adjacent = EmptyHex.normal(new Coords(3.0 * BoardUtils.hexSize(), ROOT_3 * BoardUtils.hexSize()), 2, "3.6");
    Assert.assertEquals(
        adjacent,
  ...
  public void twoAwayFails() {
    Hex reference = EmptyHex.normal(new Coords(0, 0), 1, "9.5");
    Hex adjacent = EmptyHex.normal(new Coords(6.0 * BoardUtils.hexSize(), 2 * ROOT_3 * BoardUtils.hexSize()), 2, "3.6");
